...
;; Core namespace: "dodger.kernel" ("cljs.core" for Clojurescript).
;; But Dart does not support fully-qualified names.  It does support
;; alias-qualified names, so we will qualify core stuff with an alias.
;; For dev we use a human-readable string; for prod, we'll use a UUID
;; to avoid name clashes.
(defonce dkns "dodger.kernel")
(defonce dkalias "dodger-kernel")
